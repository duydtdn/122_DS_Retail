...
const APP_MENU_URLS = {
  HOME: '/order-app/home',
  MENU: '/order-app/menu',
  SIGNAGE: '/order-app/signage',
  DETAIL: '/order-app/detail',
  CART: '/order-app/cart',
...
const renderAppMenu = () => {
  const stringHtml = `
  <div class="wrapper">
    <a href="${APP_MENU_URLS.HOME}" class="menu-item ${path === APP_MENU_URLS.HOME ||path ==APP_ROOT_URL ? 'active' : ''}">
    ...
    <a href="${APP_MENU_URLS.SIGNAGE}" class="menu-item ${path === APP_MENU_URLS.SIGNAGE ? 'active' : ''}">
    <svg width="24" height="24" viewBox="0 0 24 24" fill="" xmlns="http://www.w3.org/2000/svg">
    ...
    <a href="${APP_MENU_URLS.MENU}" class="menu-item ${path === APP_MENU_URLS.MENU ? 'active' : ''}">
    <svg width="24" height="24" viewBox="0 0 24 24" fill="" xmlns="http://www.w3.org/2000/svg">
    ...
    <a href="${APP_MENU_URLS.PLACE_ORDERS}" class="menu-item ${path === APP_MENU_URLS.PLACE_ORDERS ? 'active' : ''}">
    <svg width="24" height="24" viewBox="0 0 24 24" fill="" xmlns="http://www.w3.org/2000/svg">
